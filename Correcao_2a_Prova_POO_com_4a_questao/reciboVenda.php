    ...
    <!-- <div class="margin-top">
        <div class="container-fluid">
            ...
            if($busca == 1){
                ...
                $consulta = $pdo->query("SELECT * FROM Venda, Livro 
                                        WHERE Livro.l_titulo LIKE '$procurar%'
                                        AND c_idCliente = v_c_idCliente
                                        ORDER BY l_titulo");}

            else if($busca == 5){
                $consulta = $pdo->query("SELECT * FROM Item_venda, Venda
                                        WHERE iv_valor_total_item LIKE '$procurar%'
                                        AND iv_valor_total_item = v_valor_total
        ...
        ?>
            ...
            <tr><td><b>Venda: <?php echo $linha['v_idVenda']?></b></td>
                <td><b>Cliente: <?php echo $linha['c_nome']?></b></td>
            </tr>   
            <tr>
                <td><b>Id</b></td>
                <td><b>Titulo <?php $linha['l_titulo']?></b></td>
                <td><b>Qtd <?php $linha['l_titulo']?></b></td>
                <td><b>Valor Unitario <?php $linha['l_titulo']?></b></td>
                <td><b>Valor Total <?php $linha['iv_valor_total_venda']?></b></td>
                <td><b>Total:</b> <?php $linha['v_valor_total_venda']?></td>
                <td><b>Desconto:</b> <?php $linha['v_desconto']?></td>
                <!-- <p>Total Venda: </p> -->
            </tr> 
